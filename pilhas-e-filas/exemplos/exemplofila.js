...
console.log(`\nSaída será "Cliente 1.": ${minha_var.front()}`); // Saída: "Cliente 1."
console.log(`\nSaída será "Cliente 2.": ${minha_var.dequeue()}`); // Saída: "Cliente 2."
console.log(`\nSaída será "Cliente 3.": ${minha_var.dequeue()}`); // Saída: "Cliente 3."
